...
if __name__ == "__main__":
    ...
    for func in tqdm.tqdm(range(num_func)):
        ...
        task = metod_numerical_exp_quad(f, g, func_args, d, beta = beta_t, m = m_t, option = option_t , met = met_t)
    ...
    table.to_csv(table.to_csv('quad_testing_minimize_met_%s_beta_%s_m=%s_d=%s_p=%s.csv' % (met_t, beta_t, m_t, d, p)))
