...
def check_trid_min(unique_minimizers, func_vals_of_minimizers, d):
...
def metod_numerical_exp(f, g, func_args, d,
    ...
    check_trid_min(unique_minimizers_metod, func_vals_of_minimizers_metod, d)
    ...
    if sd_its == True:
        ...
        check_trid_min(unique_minimizers_mult, store_func_vals_mult, d)
