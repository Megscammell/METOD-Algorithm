...
def test_1():
       ...
       class_store_x0 = np.array([1., 1., 1., 3., 1., 0., 1., 9., 6., 1., 5., 9., 7., 1., 4., 1., 3.,
                                  0., 1., 3., 5., 4., 1., 3., 0., 4., 1., 3., 3., 1.])
       assert(prev_mt_alg.check_classification_sd_metod(store_minimizers,
                                                        class_store_x0,
                                                        check_func,
                                                        func_args) == 0) 
       class_store_x0 = np.array([1., 1., 0., 0., 0, 0., 1., 9., 6., 1., 5., 9., 7., 1., 4., 1., 3.,
                                  0., 1., 3., 5., 4., 1., 3., 0., 4., 1., 3., 3., 1.])
       assert(prev_mt_alg.check_classification_sd_metod(store_minimizers,
                                                        class_store_x0,
                                                        check_func,
                                                        func_args) == 0.1) 
       class_store_x0 = np.array([2, 2, 0., 0., 0, 0., 1., 9., 6., 1., 5., 9., 7., 1., 4., 1., 3.,
                                  0., 2, 3., 5., 4., 1., 3., 0., 4., 1., 3., 3., 1.])
       assert(prev_mt_alg.check_classification_sd_metod(store_minimizers,
                                                        class_store_x0,
                                                        check_func,
                                                        func_args) == 0.2) 