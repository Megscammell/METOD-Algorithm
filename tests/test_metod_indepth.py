...
def test_1(p, d, num_points_t):
    """ Check outputs of metod_indepth with minimum of several quadratic forms
    ...
    (discovered_minimas, number_minimas,
     func_vals_of_minimas, number_excessive_descents,
     store_its, des_x_points, des_z_points,
     starting_points) = mtv3.metod_indepth(f, g, func_args, d,
