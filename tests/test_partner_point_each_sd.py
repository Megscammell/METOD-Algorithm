...
def test_1():
    """Test that for loop takes correct point from all_iterations_of_sd array
     and stores correctly into
...
def test_2(p, d, iterations):
    ...
    partner_points_sd = mtv3.partner_point_each_sd(iterations_of_sd, d, beta,
