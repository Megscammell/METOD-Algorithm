...
def test_1():
    ...
    (fails_nsm_total, checks_nsm_total,
     ...
     store_all_its) = (mt_ays.main_analysis_other
                                 (d, f, g, check_func, func_args, test_beta,
                                  num_functions, num_points, projection,
                                  tolerance, option, met, initial_guess,
...
def test_2():
    ...
    (fails_nsm_total, checks_nsm_total,
     ...
     max_b_calc_func_val_nsm,
     store_all_its) = (mt_ays.main_analysis_other
                                 (d, f, g, check_func, func_args, test_beta, num_functions,
