...
def test_1():
    """Computational where the gradient is [12, 10]^T
    """
    p = 2 
    d = 2
...
def test_2():
    ...
    matrix_test = np.array([[[ 1.28094247,  0.        ,  0.        ,  0.70142069,
          0.        ],
        [ 0.        ,  5.53799473, -0.5628502 ,  0.        ,
          0.        ],
        [ 0.        , -0.5628502 ,  9.92900045,  0.        ,
          0.        ],
        [ 0.70142069,  0.        ,  0.        ,  2.75121616,
          0.        ],
        [ 0.        ,  0.        ,  0.        ,  0.        ,
          8.65595723]],
       ...
       [[ 3.63229643,  0.        ,  0.        ,  0.22780732,
        ...
        [ 0.        ,  0.        ,  8.12972135,  0.        ,
          0.        ],
        [ 0.22780732,  0.        ,  0.        ,  2.75296753,
          1.32058744],
        [-0.25117144,  0.        ,  0.        ,  1.32058744,
          2.06353554]],

       [[ 1.        ,  0.        ,  0.        ,  0.        ,
          0.        ],
        [ 0.        ,  5.89407958, -0.31840914,  0.        ,
         -0.87443975],
        [ 0.        , -0.31840914,  4.29748954, -0.34312367,
          1.99964824],
        [ 0.        ,  0.        , -0.34312367,  5.13870628,
          0.12494138],
       ...
       [[ 1.        ,  0.        ,  0.        ,  0.        ,
          0.        ],
        [ 0.        ,  6.07244368,  0.        ,  0.22222738,
          2.02860655],
        [ 0.        ,  0.        ,  6.8643249 ,  0.        ,
          0.        ],
        [ 0.        ,  0.22222738,  0.        ,  2.28175593,
          0.72934983],
        [ 0.        ,  2.02860655,  0.        ,  0.72934983,
          8.85974054]]])
