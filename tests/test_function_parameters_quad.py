...
def test_create_function():
    """ Testing functionality of slices used in create_function and comparing results by using for loop. Have not used for loop in create_function as computationally more expensive.
    """
    p = 4
    d = 5
