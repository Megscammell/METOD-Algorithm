...
def all_comparisons_matches_both(d, store_x_values_list, store_z_values_list,
    ...
    starting points to generate is dependent on num_points.
    Produce arrays that show the number of times the METOD algorithm fails
    for a given iteration number.
