...
def check_alg_cond(number_of_regions, x_1, z_1, x_2, z_2, x_points, z_points, m, d):
    ...
    x_points -- Each array within this list are steepest descent iterations to             a local minima.
    z_points -- Each array within this list is the corresponding partner                   points for each array in x_points.
    m -- warm up number
    d -- is dimension
    """
