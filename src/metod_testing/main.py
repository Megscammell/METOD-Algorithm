...
#1) Define function, gradient and dimension. Here the minimum of several quadratic forms function and gradientis used. 
f = mtv3.quad_function
g = mtv3.quad_gradient
d = 20 

#2) Will need to amend/add/delete the below if function and gradient is not the minimum of several quadratic forms. Otherwise, can update values for the below parameters
P = 5
lambda_1 = 1
lambda_2 = 10
