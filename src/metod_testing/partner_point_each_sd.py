...
def partner_point_each_sd(all_iterations_of_sd, d, beta, iterations, g,
                          func_args):
    """Compute all corresponding partner points for each iteration of steepest
     descent for a point

    Keyword arguments:
    all_iterations_of_sd -- is an array of size (iterations + 1) x d
     containing all iterations of steepest descent for a point
    d -- is dimension
